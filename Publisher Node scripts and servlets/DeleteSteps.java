...
/**
 * Servlet implementation class DeleteSteps
 */
@WebServlet("/DeleteSteps")
public class DeleteSteps extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ProcessBuilder pbl = new ProcessBuilder("node", "deleteSteps.js", myData.optString("activity"));
		...
		response.getWriter().write("Step deleted!");
	}
}
